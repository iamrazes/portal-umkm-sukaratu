    ...
    <div class="container my-4 about">
        ...
        <div>
            ...
            <div class="d-flex justify-content-between mb-4">
                <img src="{{asset('images/about2.jpg')}}" style="width: 50%; height: 360px; padding-right: 15px; object-fit: cover;" alt="">
                <img src="{{asset('images/about3.jpg')}}" style="width: 50%; height: 360px; padding-left: 15px; object-fit: cover;" alt="">
            </div>
